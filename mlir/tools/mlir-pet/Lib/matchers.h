...
///
/// A matcher of type loop is just a syntactic sugar as it behaves as a
/// "standard" band node. But it accepts particular types of nodes only.
/// Specifically, it allows other loop matcher and anyLoop only.
///

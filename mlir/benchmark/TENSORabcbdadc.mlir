...
func @main() {
  ...
  call @contraction.abc.bda.dc(%C, %A, %B) : (memref<32x32x1024xf32>, memref<32x1024x32xf32>, memref<1024x1024xf32>) -> ()
  call @print_memref_3d_f32(%C) : (memref<32x32x1024xf32>) -> ()
  return 
}

func @print_memref_3d_f32(memref<32x32x1024xf32>)

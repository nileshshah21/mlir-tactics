func @main() {
  ...
  linalg.matmul(%1, %0, %A1, %A2, %tmp1) :
    memref<f32>, memref<f32>, memref<1500x400xf32>, memref<400x2000xf32>, memref<1500x2000xf32>
  linalg.matmul(%1, %0, %tmp1, %A3, %tmp2) :
    memref<f32>, memref<f32>, memref<1500x2000xf32>, memref<2000x2200xf32>, memref<1500x2200xf32>
  linalg.matmul(%1, %0, %tmp2, %A4, %tmp3) :
    memref<f32>, memref<f32>, memref<1500x2200xf32>, memref<2200x600xf32>, memref<1500x600xf32>
  linalg.matmul(%1, %0, %tmp3, %A5, %tmp4) :
    memref<f32>, memref<f32>, memref<1500x600xf32>, memref<600x1400xf32>, memref<1500x1400xf32>
  linalg.matmul(%1, %0, %tmp4, %A6, %tmp5) :
    memref<f32>, memref<f32>, memref<1500x1400xf32>, memref<1400x1000xf32>, memref<1500x1000xf32>
